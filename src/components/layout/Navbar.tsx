    ...
    <nav className="sticky top-0 z-50 w-full border-b border-white/10 bg-background/80 backdrop-blur-md">
      <div className="container mx-auto flex h-16 items-center flex-row justify-between px-4">
        <Link href="/" className="font-heading text-xl font-bold tracking-tight text-white flex items-center gap-2 group">
          <img src="/logo.png" alt="Skill-Swap Logo" className="h-16 sm:h-20 w-auto object-contain scale-[2.5] sm:scale-[3.5] origin-center cursor-pointer group-hover:scale-[2.7] sm:group-hover:scale-[3.7] transition-transform mx-6 sm:mx-10" />
          <span className="block z-10 ml-2">Skill-Swap</span>
        </Link>
