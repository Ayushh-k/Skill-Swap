    ...
    <nav className="sticky top-0 z-50 w-full border-b border-white/10 bg-background/80 backdrop-blur-md">
      <div className="container mx-auto flex h-16 items-center flex-row justify-between px-4">
        <Link href="/" className="font-heading text-xl font-bold tracking-tight text-white flex items-center justify-center group">
          <img src="/logo.png" alt="Skill-Swap Logo" className="h-12 sm:h-14 w-auto object-contain scale-[1.3] sm:scale-[1.6] origin-center cursor-pointer group-hover:scale-[1.5] sm:group-hover:scale-[1.8] transition-transform" />
        </Link>
